...
./manage.py test --settings=mtgdb.settings_test cards.tests.helpertests && \
    ...
    ./manage.py test --settings=mtgdb.settings_test cards.tests.nametests && \
    ./manage.py test --settings=mtgdb.settings_test decks.tests.tests && \
    ./manage.py test --settings=mtgdb.settings_test decks.tests.parsertests && \
    ./manage.py test --settings=mtgdb.settings_test decks.tests.stattests && \
    ./manage.py test --settings=mtgdb.settings_test cards.tests.formattests
